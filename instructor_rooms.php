        ...
        card.addEventListener('click', function () {
            ...
            if (userRole === 'instructor') {
                Swal.fire({
                    ...
                    window.location.href = `insert_reservation.php?room_id=${encodeURIComponent(roomId)}`;
                });
            } else {
                window.location.href = `schedule_calendar.php?room_id=${encodeURIComponent(roomId)}&building_name=${encodeURIComponent(buildingName)}`;
            }
        });
    });
</script>
